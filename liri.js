...
function showTweets(){
  ...
  var screenName = {screen_name: "devalias17"};
  user.get("statuses/user_timeline", screenName, function(error, tweets, response){
    if(!error){
      for(var i = 0; i<tweets.length; i++){
        var date = tweets[i].created_at;
        console.log("@DevAlias17: " + tweets[i].text + " Created At: " + date.substring(0, 19));
        console.log("-----------------------");
        
        //adds text to log.txt file
        fs.appendFile('log.txt', "@DevAlias17: " + tweets[i].text + " Created At: " + date.substring(0, 19));
